(ns ktra-indexer.parser-test
  (:require [clojure.string :refer [includes?]]
            ...
            [java-time.api :as jt]
            [ktra-indexer.db-test :as db]
            [ktra-indexer.parser :refer [get-friday-date get-episode-info]]))

(deftest get-friday-date-test
  (testing "Getting the date of Friday"
    (let [date (jt/local-date "2020-01-10")]
      (is (= date (get-friday-date "2020-01-10T15:29:13Z")))
      (is (= date (get-friday-date "2020-01-12T15:29:13Z")))
      (is (= date (get-friday-date "2020-01-08T15:29:13Z")))
      (is (= date (get-friday-date "2020-01-06T15:29:13Z"))))))
